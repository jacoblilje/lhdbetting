...
date_input_user = st.text_input('Enter the start date (YYYY-MM-DD):')
date_input_user_end = st.text_input('Enter the end date (YYYY-MM-DD):')

# Convert the user input date to datetime format
date_input_user = pd.to_datetime(date_input_user)
date_input_user_end = pd.to_datetime(date_input_user_end)
